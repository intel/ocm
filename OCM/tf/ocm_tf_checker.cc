...
const TypeConstraintMap& GetTypeConstraintMap(std::string device_id) {
  ...
  if (!initialized) {
    ...
    // This type refers to the shape of the values to be generated
    type_constraint_map["RandomUniform"]["T"] = SupportedTypesIdx();
    // The output values generated by RandomUniform is of type float
    type_constraint_map["RandomUniform"]["dtype"] = {DT_FLOAT};
