...
def ov_validation(ov_version):
  ...
  if not os.path.exists(ov_path):
    ...
    if ov_version == "openvino_2021.1.110" or ov_version == "openvino_2021.2.185" or ov_version == "openvino_2021.3.394"or "openvino_2021.4" in ov_version or "openvino_2022.1.0" or "openvino_2022.2.0" or "openvino_2022.3.0" in ov_version:
